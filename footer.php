...
?>
  ...
  <div id="footer">
    ...
    <div class="footerNavWrapper">
      ...
      <p class="quickLinks"><a href="#"> <img src="<?php bloginfo( 'template_directory' ); ?>/images/icon-fb.gif" alt="Find Us on Facebook" width="16" height="16" align="texttop" /> Find Us on Facebook</a> <a href="#"> <img src="<?php bloginfo( 'template_directory' ); ?>/images/icon-itunesU.gif" alt="Listen on iTunes U" width="16" height="16" align="texttop" /> Listen on iTunes U</a> <a href="#"> <img src="<?php bloginfo( 'template_directory' ); ?>/images/icon-twitter.gif" alt="Follow Us on Twitter" width="16" height="16" align="texttop" /> Follow Us on Twitter</a> <a href="#"> <img src="<?php bloginfo( 'template_directory' ); ?>/images/icon-youtube.gif" alt="Watch on YouTube EDU" width="16" height="16" align="texttop" /> Watch on YouTube EDU</a></p>
